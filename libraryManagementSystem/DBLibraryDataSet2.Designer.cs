...
namespace libraryManagementSystem.DBLibraryDataSet2TableAdapters {
    ...
    public partial class publisherTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[publisher] ([fullname]) VALUES (@fullname);\r\nSELECT publisherI" +
                "D, fullname FROM publisher WHERE (publisherID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[publisher] SET [fullname] = @fullname WHERE (([publisherID] = @Orig" +
                "inal_publisherID) AND ([fullname] = @Original_fullname));\r\nSELECT publisherID, f" +
                "ullname FROM publisher WHERE (publisherID = @publisherID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT publisherID, fullname FROM dbo.publisher";
        ...
        public virtual int Fill(DBLibraryDataSet2.publisherDataTable dataTable) {
        ...
        public virtual DBLibraryDataSet2.publisherDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DBLibraryDataSet2.publisherDataTable dataTable = new DBLibraryDataSet2.publisherDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DBLibraryDataSet2.publisherDataTable dataTable) {
        ...
        public virtual int Delete(int Original_publisherID, string Original_fullname) {
        ...
        public virtual int Update(string fullname, int Original_publisherID, string Original_fullname, int publisherID) {
            if ((fullname == null)) {
                throw new global::System.ArgumentNullException("fullname");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string fullname, int Original_publisherID, string Original_fullname) {
            return this.Update(fullname, Original_publisherID, Original_fullname, Original_publisherID);
        }
    }
